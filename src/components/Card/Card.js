...
function Card({ id, imgUrl, title, price, onFavorite, onPlus, favorited = false, added = false, loading = false }) {
    ...
    return (
        <div className={style.card}>
            ...
            >
                <rect x="0" y="162" rx="10" ry="10" width="150" height="15" />
                <rect x="0" y="188" rx="10" ry="10" width="93" height="15" />
                <rect x="4" y="224" rx="10" ry="10" width="80" height="25" />
                <rect x="103" y="211" rx="5" ry="5" width="37" height="39" />

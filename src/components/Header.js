    ...
    <header className="head   d-flex justify-between align-center p-40">
      <div className="d-flex align-center clear">
        ...
        <div className="">
          ...
          <p>Магазин оригинальнх кросовок</p>
        </div>
      </div>
      <ul className="d-flex align-center ">
        <li onClick={props.onClickCart} /*Нажав на эту li ты вызовешь функцию описанную в app */ className=" d-flex align-center mr-30">
          <svg className="basketSvg mr-10" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
